...
# Crea y entrena el modelo Gradient Boosting
model = GradientBoostingClassifier(n_estimators= 509, learning_rate= 0.68, max_depth= 1, min_samples_split= 8, min_samples_leaf= 2, subsample= 0.69, loss= 'log_loss',random_state=42)
...
df_test[["Customer Id", "Claim"]].to_csv("Submits/submit_Boost_Class.csv", index=False)
